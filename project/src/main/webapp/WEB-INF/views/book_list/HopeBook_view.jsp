...
<div style="text-align: center;">
   ...
   <table style="width:100%; text-align: center;">
    ...
    <tr>
     <td>제목</td>
     <td colspan="2"><input id="hopeBook_title" name="hopeBook_title" class="input" value="${row.hopeBook_title}" readonly></td>
    </tr>
    <tr>
     <td>신청자</td>
     <td colspan="2"><input id="name" name="name" class="input" value="${row.name}" readonly></td>
    </tr>
    <tr>
     <td>신청도서 제목</td>
     <td colspan="2"><input id="hopeBook_bookname" name="hopeBook_bookname" class="input" value="${row.hopeBook_bookname}" readonly></td>
    </tr>
     <tr>
     <td>신청도서 저자</td>
     <td colspan="2"><input id="hopeBook_author" name="hopeBook_author" class="input" value="${row.hopeBook_author}" readonly></td>
    </tr>
    <tr>
     <td>신청사유</td>
     <td colspan="2">${row.hopeBook_content}
   ...
   <tr>
     <td>답변</td>
     <td colspan="2">${row.hopeBook_content}</td>
    </tr>
   </c:if>
   </table>
   </c:forEach>
